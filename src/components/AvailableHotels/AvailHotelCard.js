            ...
            <div className="avail-hotel-item">
              <div>
                ...
                <div className="avail-hotel-photos">
                  <Swiper spaceBetween={3} slidesPerView={null}>
                    ...
                    <SwiperSlide>
                      <img
                        src="https://pravodeneg.net/wp-content/uploads/2019/03/the-metropole-hotel_2-300x300.jpg"
                        alt="reception"
                    ...
                    <SwiperSlide>
                      <img
                        src="https://parkingaccess.com/blog/wp-content/uploads/2020/08/Hotel-Parking-300x225.jpg"
                        alt="Parking"
                        className="swiper-photo"
                      />
                    </SwiperSlide>
                    <SwiperSlide>
                      <img
                        src="https://www.myboutiquehotel.com/photos/107981/lokal-hotel-restaurant-yogyakarta-001-56259-300x300.jpg"
                        alt="Swimming pool"
                        className="swiper-photo"
                      />
                    </SwiperSlide>
                    <SwiperSlide>
                      <img
                        src="https://i1.photo.2gis.com/images/branch/20/2814749809595641_4214_300x300.jpg"
                        alt="Billiard"
                        className="swiper-photo"
                      />
                    </SwiperSlide>
                    <SwiperSlide>
                      <img
                        src="https://pro2-bar-s3-cdn-cf4.myportfolio.com/1d4c1135e9abb7888dee4822c0ff3922/fa0fc172-9dee-4aa3-861c-7c0596f0a203_car_1x1.jpg?h=9905e8995958e51e88dd76fda632af4e"
                        alt="Restaurant"
                        className="swiper-photo"
                      />
                    </SwiperSlide>
              ...
              <div className="avail-hotel-text">
                ...
                <div className="about-hotel">
                  <p>
                    The 5-star, Radisson Blu Royal Astorija Hotel, Vilnius is a city centre landmark
                    and the city’s premiere accommodation choice. The hotel welcomes guests in a
                    stunning Baroque style building dating back to 1901, gracefully combining
                    vintage architecture and design with modern services and amenities. In April
                    2014, the hotel completed refurbishment of its Superior and Business Class
                    Rooms.
                  </p>
